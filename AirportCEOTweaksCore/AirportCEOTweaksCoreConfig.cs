...
{
    public static ConfigEntry<bool> ExtraDebugLogs { get; private set; }
    ...
    {
        ExtraDebugLogs = ConfigRef.Bind("Debug", "Enable Extra Debug Logging", true, "Increases the amount of logging the mod does, making the log file more useful to developers.");
